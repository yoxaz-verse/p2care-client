...
export default function Footer() {
  return (
    <>
      <div className="flex flex-col w-full p-[2rem] w-full">
        <div className="flex flex-row justify-around items-center rounded-2xl h-[20vh] bg-primary">
          <h1 className="text-3xl md:text-4xl xl:text-5xl font-bold text-white">Have any enquiry</h1>
        ...
        <div className="flex flex-col md:flex-row justify-around w-full p-[2rem]">
          <div className="flex gap-2 md:gap-4 flex-col">
            <Image src={logo} />
            <h1>Clarity gives you the blocks and components you need to create a truly professional website.</h1>
        ...
        <Divider />
        <h1 className="p-[1rem] text-center w-full">© Copyright {new Date().getUTCFullYear()}, All Rights Reserved </h1>
      </div>
    </>
  )
}
