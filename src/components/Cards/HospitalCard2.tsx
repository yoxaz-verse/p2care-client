      ...
      <CardBody className="flex flex-row gap-10">
        ...
        <div className="grid grid-rows-1 md:grid-rows-2 w-full">
          ...
          <div className="flex flex-row flex-wrap items-start md:items-center font-[500] gap-2 md:gap-4">
            ...
            <h3 className="flex flex-row items-center gap-2"><span className="w-2 h-2 rounded-full bg-black" />Established 2016</h3>
            <h3 className="flex flex-row items-center gap-2"><span className="w-2 h-2 rounded-full bg-black" />60 Beds</h3>
            <h3 className="flex flex-row items-center gap-2"><span className="w-2 h-2 rounded-full bg-black" />10 Doctors</h3>
          </div>
          ...
          <div className="justify-self-start md:justify-self-end">
            <Button radius="full" className="flex flex-row gap-2 text-[16px] md:text-[24px] px-[.5rem] md:px-[1rem]" color="primary">
              <IoMdCall />
              <p>+91 0987654321</p>
            </Button>
          </div>
