    ...
    <>
      <Card>
        <CardBody className='flex flex-row gap-4 w-full'>
          <img src={apolloDoc} className='w-[40px] md:w-[80px] rounded-full h-[40px] md:h-[80px]' alt='apolloDoc' />
    ...
    <Card>
      <CardBody className='flex flex-col h-full'>
        <div className='flex flex-row gap-4'>
          <img src={apolloLogo} className='h-[100px] md:h-[220px] w-[100px] md:w-[220px] rounded-full' alt='image' />
          <div className="flex flex-col justify-between gap-4">
            <h1 className='text-2xl md:text-4xl font-extrabold'>Apollo Spectra Hospital</h1>
            <div className="flex flex-row w-full gap-4">
              <h1 className='text-md text-blue-500 font-bold md:text-xl'>Multi-specialty Hospital</h1>
            ...
            <div className='flex flex-row gap-2 justify-between'>
              <h1 className='text-lg'><span className='font-extrabold'>₹ 300 - ₹700</span> Consultation Fees</h1>
            </div>
            ...
            <div className='flex flex-col md:flex-row w-full justify-between items-start md:items-center gap-4'>
              ...
              <h1>Know More</h1>
              <button className='bg-blue-500 rounded-full px-[10px] py-[5px] text-white font-bold'>Consult Now</button>
            </div>
          </div>
        </div>
      </CardBody>
