...
export default function DepartmentCard(props: DepartmentCardProps) {
  ...
  return (
    <Card
      ...
      isPressable
      className="h-[300px] rounded-[20px] hover:bg-secondary-200 hover:cursor-pointer"
    >
      ...
      <CardFooter className="flex flex-col gap-2">
        <h4
          className={`font-[600] text-[${
            props.title.length > 27 ? 11 : 15
          }px] lg:text-[${props.title.length > 27 ? 16 : 20}px] text-center`}
        >
          {props.title}
        </h4>
