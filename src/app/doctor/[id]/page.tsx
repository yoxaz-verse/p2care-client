    ...
    <section>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
        <div className="h-[200px]">
          <h1 className="font-bold text-xl md:text-2xl">Contact Details</h1>
          <div className="flex flex-col gap-2">
            <h1 className="text-[#011632] text-lg">Phone: +91 343 434 34 34</h1>
            <h1 className="text-[#011632] text-lg">
              Email : doctor21@gmail.com
            </h1>
          </div>
        </div>
        <div className="h-[200px]">
          <h1 className="font-bold text-xl md:text-2xl">Visiting Time</h1>
          <div className="flex flex-col gap-2">
