...
function AboutUs() {
  return <section className="flex flex-col justify-center gap-8 text-center">
    ...
    <div className="bg-[#F6F6F6] roundex-xl flex flex-row  p-0 md:p-10 justify-center w-full ">
      ...
      <Image src={hospitalDocAbout} alt="image" width={834} height={600} className="w-[254px] h-[300px] z-2 md:w-[700px] md:h-[700px]" />
    </div>
    <div className="flex flex-col">
      ...
      <div className="grid text-start text-[20px] grid-cols-1 md:grid-cols-2">
        <ol className="leading-[20px] md:leading-[44px] list-decimal">
        ...
        <ol start={5} className="list-decimal leading-[20px] md:leading-[44px]">
          ...
          <li>Diagnostic Tests through P2care Associate Labs to get samples collected from the co  ort and safety of one’s home.</li>
    ...
    <div className="rounded-xl flex flex-col md:flex-row items-center p-10  justify-around w-full">
      ...
      <Image src={aboutusdata} width={1000} height={1000} className="w-[600px]" alt="image" />
    </div>
    <div className="flex flex-col items-center">
      <h1 className="text-[27px] md:text-[54px] font-semibold">What doctors say about us</h1>
      <Testimoinals />
    </div>
  </section>;
}
