...
import Testimoinals from "@/components/Cards/Testimonal";

function AboutUs() {
  return (
    <section className="flex flex-col justify-center gap-8 text-center relative">
      <h3 className="text-[32px] md:text-[54px] font-[700] text-primary ">
      ...
      <div className="bg-[#F6F6F6] roundex-xl flex flex-row p-5 h-[400px] lg:h-[700px] p-0 md:p-10 justify-center  w-full relative">
        <div className="flex flex-col justify-center w-full">
          <h3 className="text-[32px] md:text-[54px] font-semibold text-start">
            Health is a Habit
          </h3>
          <p className="text-md text-start leading-2 md:leading-8 z-10 w-[300px] lg:w-[700px] ">
      ...
      <div className="flex flex-col">
        <h3 className="text-[34px] md:text-[54px] text-start font-semibold">
          Our Offerings
        </h3>
        <div className="grid text-start text-[15px] lg:text-[20px] grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <ol start={5} className="list-decimal">
            ...
            <li>
              ...
              collected from the co ort and safety of one’s home.
            </li>
            <li>
      ...
      <div className="flex flex-col gap-2">
        <h3 className="text-[24px] lg:text-lg font-semibold">
        ...
        <div className="flex flex-col lg:flex-row w-full gap-[1rem] justify-around">
          <div className="flex flex-col items-center">
            ...
            <div className="flex flex-col items-center">
              ...
              <h3 className="text-[14px] md:text-md">
      ...
      <div className="rounded-xl flex flex-col md:flex-row items-center p-10  justify-around w-full">
      ...
      <div className="flex flex-col items-center">
        <h1 className="text-[27px] md:text-[54px] font-semibold">
