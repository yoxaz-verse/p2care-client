...
function AboutUs() {
  return (
    <section className="flex flex-col justify-center gap-8 text-center">
      <h3 className="text-[27px] md:text-[54px] text-primary font-bold">
        Quality Healthcare Made Simple
      </h3>
      <h3 className="text-md md:text-lg font-semibold">Our Mission</h3>
      <p className="text-sm md:text-md text-center font-[400]">
        P2care is on a mission to make quality healthcare affordable and
        accessible for over a billion+ Indians. We believe in empowering our
        users with the most accurate, comprehensive, and curated information and
      ...
      <div className="bg-[#F6F6F6] roundex-xl flex flex-row items-center p-10  justify-around w-full">
        <div className="flex flex-col w-full">
          <h3 className="text-[20px] md:text-[54px] font-semibold text-start">
            Health is a Habit
          </h3>
          <p className="text-sm md:text-md text-start leading-2 md:leading-8">
            ...
            hope. P2care wants to make this journey easy for every Indian and
      ...
      <div className="flex flex-col">
        <h3 className="text-[27px] md:text-[54px] text-start font-semibold">
          Our Offerings
        </h3>
        <div className="grid text-start text-[10px] md:text-[20px] grid-cols-2">
          <ol className="list-decimal">
            ...
            <li>
              ...
              clinics with doctors who use P2care Prime.
            </li>
            <li>
          ...
          <ol className="list-decimal">
            <li>
              Ray, P2care’s award-winning practice management software, which is
              used by 10,000+ clinics.
            </li>
            <li>
            ...
            <li>
              Diagnostic Tests through P2care Associate Labs to get samples
        ...
        <div className="flex flex-row w-full gap-[1rem] justify-around">
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="flex flex-col items-center">
              ...
              <h3 className="text-sm md:text-md">
                P2care works on trust. We are aware of the responsibility placed
                on us by 30 crore+ patients and over a lakh doctors. We always
                have and always will do everything we possibly can to uphold
                this trust.
              </h3>
            </div>
          </div>
      ...
      <div className="roundex-xl flex flex-row items-center p-10  justify-around w-full">
        <div className="flex flex-col w-full">
          <h3 className="text-[20px] md:text-[54px] text-start font-semibold">
