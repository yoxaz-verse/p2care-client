  ...
  return (
    <AuthLayout src={forgotpass}>
      <div className="flex flex-col justify-center gap-[2rem] items-center">
        ...
        <Input value={password} onValueChange={(e) => setPassword(e)} radius="none" type="password" className="bg-white outline-none border border-gray-200" placeholder="Enter new password" />
        <Input value={currpassword} onValueChange={(e) => setcurrPassword(e)} radius="none" type="password" className="bg-white outline-none border border-gray-200" placeholder="Re-Enter Enter your new password" />
        <Button color="primary" radius="none" className="w-full" >Login</Button>
      </div>
    </AuthLayout>
  )
}
